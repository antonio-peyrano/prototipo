 ...
 */
    ...
    include_once ($_SERVER['DOCUMENT_ROOT']."/ecole/php/backend/bl/usuarios/usuarios.class.php"); //Se carga la referencia de la clase para manejo de la entidad usuarios.
